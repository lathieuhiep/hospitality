...
final class AboutContainer
{
    ...
    protected static function register(): void
    {
        Container::make(
            'post_meta',
            esc_html__('About Page Options', 'hospitality')
        )
            ...
            ->add_tab(
                ...
                esc_html__('Điểm nổi bật', 'hospitality'),
                HighlightsTab::fields()
            )
            ->add_tab(
                esc_html__('Không gian sống', 'hospitality'),
                LivingSpaceTab::fields()
            )
            ->add_tab(
                esc_html__('Đầu tư + vận hành.', 'hospitality'),
                OperatorTab::fields()
            )
            ->add_tab(
                esc_html__('Dịch vụ bao gồm', 'hospitality'),
