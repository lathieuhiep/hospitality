 ...
 * @return void
 */
function hospitality_load_text_domain(): void
{
 ...
 * @return void
 */
function hospitality_add_theme_support(): void
{
 ...
 * @return void
 */
function hospitality_register_nav_menus(): void
{
    register_nav_menus([
        'main_menu_left' => esc_html__('Menu chính bên trái', 'hospitality'),
        'main_menu_right' => esc_html__('Menu chính bên phải', 'hospitality'),
        'main_menu_device' => esc_html__('Menu chính hiển thị cho thiết bị (mobile, tablet)', 'hospitality'),
    ]);
}
 ...
 * @return void
 */
function hospitality_output_fallback_favicon(): void
{
    if (!has_site_icon()) {
 ...
 * @return void
 */
function hospitality_remove_unnecessary_assets(): void
{
 ...
 */
function hospitality_disable_emojis_tinymce(array $plugins): array {
 ...
 */
function hospitality_disable_gutenberg_editor(): bool {
    return false;
}
 ...
 * @return void
 */
function hospitality_init(): void
{
    // Theme setup
    hospitality_load_text_domain();
    hospitality_add_theme_support();
    hospitality_register_nav_menus();

    // Cleanup and optimization hooks
    add_action('wp_head', 'hospitality_output_fallback_favicon');
    add_action('init', 'hospitality_remove_unnecessary_assets');
    add_filter('tiny_mce_plugins', 'hospitality_disable_emojis_tinymce');
    add_filter('xmlrpc_enabled', '__return_false');
    add_filter('use_block_editor_for_post_type', 'hospitality_disable_gutenberg_editor');
    add_filter('use_widgets_block_editor', '__return_false');
}
add_action('after_setup_theme', 'hospitality_init');