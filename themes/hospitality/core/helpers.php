 ...
 * @return T|null
 */
function hospitality_get_opt(string $class)
{
 ...
 */
function hospitality_pagination_custom( $args = array() ): void
{
    global $wp_query;
    ...
    $defaults = array(
        'type' => 'list',
        'mid_size' => 2,
        'prev_text' => esc_html__('Trước', 'hospitality'),
        'next_text' => esc_html__('Sau', 'hospitality'),
        'screen_reader_text' => '&nbsp;',
    );
 ...
 */
function hospitality_pagination_query( $query, $args = array() ): void
{
...
// replace number
function hospitality_preg_replace_ony_number( $string ): string|null {
    $number = '';
