    ...
    <div class="col-xl-5 offset-xl-6">
        <div class="item-list">
            <div class="f-item wow fadeInUp">
                <span class="f-sub"><?php esc_html_e('Capacity', 'hospitality'); ?></span>
            ...
            <div class="f-item wow fadeInUp">
                <span class="f-sub"><?php esc_html_e('Area', 'hospitality'); ?></span>
            ...
            <?php if ( ! empty( $meta_location ) ) : ?>
                <div class="f-item wow fadeInUp">
                    <span class="f-sub"><?php esc_html_e('Location', 'hospitality'); ?></span>
            ...
            <?php if ( ! empty( $room['detail'] ) ) : ?>
                <div class="f-item wow fadeInUp">
                    <span class="f-sub"><?php esc_html_e('Detail', 'hospitality'); ?></span>
        ...
        <div class="item-btn wow fadeInUp">
            <span href="#" class="btn-book popover-trigger" data-target="popover-book-2">
              <?php esc_html_e('Đặt phòng ngay', 'hospitality'); ?>
            </span>
        </div>
    </div>
</div>