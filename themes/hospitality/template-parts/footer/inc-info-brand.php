...
// Get contact info
$phone = hospitality_get_opt(ContactOptions::class)?->get_otp_contact_phone() ?? '091 3833 333';
$email = hospitality_get_opt(ContactOptions::class)?->get_opt_contact_email() ?? 'thaihoangapartmenthd@gmail.com';
$social_links = hospitality_get_opt(ContactOptions::class)?->get_opt_contact_social_links() ?? [];
?>
